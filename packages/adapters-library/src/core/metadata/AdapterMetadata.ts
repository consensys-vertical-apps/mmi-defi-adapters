...
import AaveV2StableDebtTokenAvalancheStableDebtTokenV2 from '../../adapters/aave-v2/products/stable-debt-token/metadata/avax.stable-debt-token-v2.json'
...
import AaveV2StableDebtTokenPolygonStableDebtTokenV2 from '../../adapters/aave-v2/products/stable-debt-token/metadata/matic.stable-debt-token-v2.json'
import AaveV2VariableDebtTokenAvalancheVariableDebtTokenV2 from '../../adapters/aave-v2/products/variable-debt-token/metadata/avax.variable-debt-token-v2.json'
...
import AaveV2VariableDebtTokenPolygonVariableDebtTokenV2 from '../../adapters/aave-v2/products/variable-debt-token/metadata/matic.variable-debt-token-v2.json'
import AaveV3ATokenArbitrumATokenV3 from '../../adapters/aave-v3/products/a-token/metadata/arb.a-token-v3.json'
import AaveV3ATokenAvalancheATokenV3 from '../../adapters/aave-v3/products/a-token/metadata/avax.a-token-v3.json'
...
import AaveV3ATokenOptimismATokenV3 from '../../adapters/aave-v3/products/a-token/metadata/op.a-token-v3.json'
import AaveV3ATokenPolygonATokenV3 from '../../adapters/aave-v3/products/a-token/metadata/matic.a-token-v3.json'
import AaveV3StableDebtTokenArbitrumStableDebtTokenV3 from '../../adapters/aave-v3/products/stable-debt-token/metadata/arb.stable-debt-token-v3.json'
import AaveV3StableDebtTokenAvalancheStableDebtTokenV3 from '../../adapters/aave-v3/products/stable-debt-token/metadata/avax.stable-debt-token-v3.json'
...
import AaveV3StableDebtTokenOptimismStableDebtTokenV3 from '../../adapters/aave-v3/products/stable-debt-token/metadata/op.stable-debt-token-v3.json'
import AaveV3StableDebtTokenPolygonStableDebtTokenV3 from '../../adapters/aave-v3/products/stable-debt-token/metadata/matic.stable-debt-token-v3.json'
import AaveV3VariableDebtTokenArbitrumVariableDebtTokenV3 from '../../adapters/aave-v3/products/variable-debt-token/metadata/arb.variable-debt-token-v3.json'
import AaveV3VariableDebtTokenAvalancheVariableDebtTokenV3 from '../../adapters/aave-v3/products/variable-debt-token/metadata/avax.variable-debt-token-v3.json'
...
import AaveV3VariableDebtTokenOptimismVariableDebtTokenV3 from '../../adapters/aave-v3/products/variable-debt-token/metadata/op.variable-debt-token-v3.json'
import AaveV3VariableDebtTokenPolygonVariableDebtTokenV3 from '../../adapters/aave-v3/products/variable-debt-token/metadata/matic.variable-debt-token-v3.json'
...
import ConvexSidechainStakingArbitrumProtocolToken from '../../adapters/convex/products/sidechain-staking/metadata/arb.protocol-token.json'
import ConvexSidechainStakingPolygonProtocolToken from '../../adapters/convex/products/sidechain-staking/metadata/matic.protocol-token.json'
...
import GmxGlpArbitrumGlp from '../../adapters/gmx/products/glp/metadata/arb.glp.json'
import GmxGlpAvalancheGlp from '../../adapters/gmx/products/glp/metadata/avax.glp.json'
...
import StargatePoolArbitrumLpToken from '../../adapters/stargate/products/pool/metadata/arb.lp-token.json'
