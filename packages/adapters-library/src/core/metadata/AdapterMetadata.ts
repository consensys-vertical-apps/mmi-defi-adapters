...
import AaveV2StableDebtTokenAvalancheStableDebtTokenV2 from '../../adapters/aave2/products/stable-debt-token/metadata/avalanche.stable-debt-token-v2.json'
import AaveV2StableDebtTokenEthereumStableDebtTokenV2 from '../../adapters/aave2/products/stable-debt-token/metadata/ethereum.stable-debt-token-v2.json'
import AaveV2StableDebtTokenPolygonStableDebtTokenV2 from '../../adapters/aave2/products/stable-debt-token/metadata/polygon.stable-debt-token-v2.json'
...
import PancakeswapV2PoolArbitrumProtocolToken from '../../adapters/pancakeswap/products/pool/metadata/arbitrum.protocol-token.json'
import PancakeswapV2PoolBaseProtocolToken from '../../adapters/pancakeswap/products/pool/metadata/base.protocol-token.json'
import PancakeswapV2PoolBscProtocolToken from '../../adapters/pancakeswap/products/pool/metadata/bsc.protocol-token.json'
import PancakeswapV2PoolEthereumProtocolToken from '../../adapters/pancakeswap/products/pool/metadata/ethereum.protocol-token.json'
import PancakeswapV2PoolLineaProtocolToken from '../../adapters/pancakeswap/products/pool/metadata/linea.protocol-token.json'
