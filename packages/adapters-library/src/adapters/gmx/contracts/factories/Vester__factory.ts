...
export class Vester__factory {
  ...
  static createInterface(): VesterInterface {
    return new Interface(_abi) as VesterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Vester {
    return new Contract(address, _abi, runner) as unknown as Vester;
  }
}
