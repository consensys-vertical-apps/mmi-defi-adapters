...
export interface Cerc20Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "_setReserveGuardian",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proxyInitialize",
    values: [
      AddressLike,
      AddressLike,
      AddressLike,
  ...
  encodeFunctionData(
    functionFragment: "reserveGuardian",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace NewReserveGuardianEvent {
  export type InputTuple = [
    oldReserveGuardian: AddressLike,
    newReserveGuardian: AddressLike
  ];
  export type OutputTuple = [
...
export interface Cerc20 extends BaseContract {
  ...
  _setReserveGuardian: TypedContractMethod<
    [newReserveGuardian: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  proxyInitialize: TypedContractMethod<
    [
      underlying_: AddressLike,
      comptroller_: AddressLike,
      interestRateModel_: AddressLike,
  ...
  reserveGuardian: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "_setReserveGuardian"
  ): TypedContractMethod<
    [newReserveGuardian: AddressLike],
    [bigint],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "proxyInitialize"
  ): TypedContractMethod<
    [
      underlying_: AddressLike,
      comptroller_: AddressLike,
  ...
  getFunction(
    nameOrSignature: "reserveGuardian"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getEvent(
    key: "NewReserveGuardian"
  ): TypedContractEvent<
    NewReserveGuardianEvent.InputTuple,
    NewReserveGuardianEvent.OutputTuple,
    NewReserveGuardianEvent.OutputObject
  >;
  getEvent(
    key: "Redeem"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "NewReserveGuardian(address,address)": TypedContractEvent<
      NewReserveGuardianEvent.InputTuple,
      NewReserveGuardianEvent.OutputTuple,
      NewReserveGuardianEvent.OutputObject
    >;
    NewReserveGuardian: TypedContractEvent<
      NewReserveGuardianEvent.InputTuple,
      NewReserveGuardianEvent.OutputTuple,
      NewReserveGuardianEvent.OutputObject
    >;
