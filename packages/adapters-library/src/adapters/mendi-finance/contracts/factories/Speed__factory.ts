...
import type { Speed, SpeedInterface } from "../Speed.js";
...
export class Speed__factory {
  static readonly abi = _abi;
  static createInterface(): SpeedInterface {
    return new Interface(_abi) as SpeedInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Speed {
    return new Contract(address, _abi, runner) as unknown as Speed;
  }
}
