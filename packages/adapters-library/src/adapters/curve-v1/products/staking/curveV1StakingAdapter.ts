...
import { CrvMinter__factory, GaugeN__factory, GaugeSingle__factory } from '../../../curve/contracts'
...
export class CurveV1StakingAdapter
  implements IProtocolAdapter, IMetadataBuilder
{
  ...
  getProtocolDetails(): ProtocolDetails {
    return {
      ...
      name: 'CurveV1',
      description: 'CurveV1 defi adapter',
      siteUrl: 'https:',
      iconUrl: 'https://',
  ...
  async getRewardWithdrawals({
    ...
    const protocolToken =
      await this.getProtocolToken(protocolTokenAddress)
