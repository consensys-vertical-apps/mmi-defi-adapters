...
export class Susde__factory {
  static readonly abi = _abi;
  static createInterface(): SusdeInterface {
    return new Interface(_abi) as SusdeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Susde {
    return new Contract(address, _abi, runner) as unknown as Susde;
  }
}
