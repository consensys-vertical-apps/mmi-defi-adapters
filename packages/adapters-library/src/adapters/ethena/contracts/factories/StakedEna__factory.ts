...
export class StakedEna__factory {
  static readonly abi = _abi;
  static createInterface(): StakedEnaInterface {
    return new Interface(_abi) as StakedEnaInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): StakedEna {
    return new Contract(address, _abi, runner) as unknown as StakedEna;
  }
}
