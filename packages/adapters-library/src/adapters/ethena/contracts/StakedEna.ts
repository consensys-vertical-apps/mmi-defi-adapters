...
export interface StakedEnaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BLACKLISTED_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "BLACKLIST_MANAGER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "MAX_VESTING_PERIOD",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateVestingPeriod",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "useNonce", values?: undefined): string;
  encodeFunctionData(
...
export namespace CooldownStartedEvent {
  ...
  export type OutputTuple = [cooler: string, assets: bigint, shares: bigint];
  export interface OutputObject {
    cooler: string;
    assets: bigint;
    shares: bigint;
...
export namespace StakedENARedistributedEvent {
  export type InputTuple = [
    from: AddressLike,
    to: AddressLike,
    amount: BigNumberish
...
export namespace VestingDurationUpdatedEvent {
  export type InputTuple = [
    previousDuration: BigNumberish,
    newDuration: BigNumberish
  ];
...
export interface StakedEna extends BaseContract {
  connect(runner?: ContractRunner | null): StakedEna;
  waitForDeployment(): Promise<this>;

  interface: StakedEnaInterface;
  ...
  BLACKLISTED_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  MAX_VESTING_PERIOD: TypedContractMethod<[], [bigint], "view">;
  ...
  initialize: TypedContractMethod<
    [_asset: AddressLike, _initialRewarder: AddressLike, _owner: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  updateVestingPeriod: TypedContractMethod<
    [newVestingPeriod: BigNumberish],
    [void],
    "nonpayable"
  >;

  useNonce: TypedContractMethod<[], [bigint], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "BLACKLISTED_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "BLACKLIST_MANAGER_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "MAX_VESTING_PERIOD"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "updateVestingPeriod"
  ): TypedContractMethod<
    [newVestingPeriod: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "StakedENARedistributed"
  ): TypedContractEvent<
    StakedENARedistributedEvent.InputTuple,
    StakedENARedistributedEvent.OutputTuple,
    StakedENARedistributedEvent.OutputObject
  >;
  getEvent(
    key: "TokensRescued"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "VestingDurationUpdated"
  ): TypedContractEvent<
    VestingDurationUpdatedEvent.InputTuple,
    VestingDurationUpdatedEvent.OutputTuple,
    VestingDurationUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "Withdraw"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "CooldownStarted(address,uint256,uint256)": TypedContractEvent<
      CooldownStartedEvent.InputTuple,
      CooldownStartedEvent.OutputTuple,
      CooldownStartedEvent.OutputObject
    >;
    ...
    "StakedENARedistributed(address,address,uint256)": TypedContractEvent<
      StakedENARedistributedEvent.InputTuple,
      StakedENARedistributedEvent.OutputTuple,
      StakedENARedistributedEvent.OutputObject
    >;
    StakedENARedistributed: TypedContractEvent<
      StakedENARedistributedEvent.InputTuple,
      StakedENARedistributedEvent.OutputTuple,
      StakedENARedistributedEvent.OutputObject
    >;
    ...
    "VestingDurationUpdated(uint24,uint24)": TypedContractEvent<
      VestingDurationUpdatedEvent.InputTuple,
      VestingDurationUpdatedEvent.OutputTuple,
      VestingDurationUpdatedEvent.OutputObject
    >;
    VestingDurationUpdated: TypedContractEvent<
      VestingDurationUpdatedEvent.InputTuple,
      VestingDurationUpdatedEvent.OutputTuple,
      VestingDurationUpdatedEvent.OutputObject
    >;
