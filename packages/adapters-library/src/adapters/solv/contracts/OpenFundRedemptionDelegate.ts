...
export interface OpenFundRedemptionDelegateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
  ...
  encodeFunctionData(
    functionFragment: "setRedeemNavOnlyMarket",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace ClaimEvent {
  export type InputTuple = [
    ...
    claimCurrencyAmount: BigNumberish
  ];
  export type OutputTuple = [
    to: string,
    tokenId: bigint,
...
export interface OpenFundRedemptionDelegate extends BaseContract {
  connect(runner?: ContractRunner | null): OpenFundRedemptionDelegate;
  waitForDeployment(): Promise<this>;

  interface: OpenFundRedemptionDelegateInterface;
  ...
  setRedeemNavOnlyMarket: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setRedeemNavOnlyMarket"
  ): TypedContractMethod<
    [slot_: BigNumberish, nav_: BigNumberish],
    [void],
    "nonpayable"
  ...
  filters: {
    ...
    "Claim(address,uint256,uint256,address,uint256)": TypedContractEvent<
      ClaimEvent.InputTuple,
      ClaimEvent.OutputTuple,
      ClaimEvent.OutputObject
    >;
    ...
    "Repay(uint256,address,address,uint256)": TypedContractEvent<
      RepayEvent.InputTuple,
      RepayEvent.OutputTuple,
      RepayEvent.OutputObject
    >;
