...
import type {
  ...
  OpenFundRedemptionConcreteInterface,
} from "../OpenFundRedemptionConcrete.js";
...
export class OpenFundRedemptionConcrete__factory {
  static readonly abi = _abi;
  static createInterface(): OpenFundRedemptionConcreteInterface {
    return new Interface(_abi) as OpenFundRedemptionConcreteInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as OpenFundRedemptionConcrete;
  }
}
