...
import type {
  ...
  AccountantWithRateProvidersInterface,
} from "../AccountantWithRateProviders.js";
...
export class AccountantWithRateProviders__factory {
  static readonly abi = _abi;
  static createInterface(): AccountantWithRateProvidersInterface {
    return new Interface(_abi) as AccountantWithRateProvidersInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AccountantWithRateProviders;
  }
}
