...
export interface DTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_TOKENID"
      | "approve"
...
export interface DToken extends BaseContract {
  connect(runner?: ContractRunner | null): DToken;
  ...
  BASE_TOKENID: TypedContractMethod<[], [bigint], "view">;
