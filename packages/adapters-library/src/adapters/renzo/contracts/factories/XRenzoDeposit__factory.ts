...
import type {
  XRenzoDeposit,
  XRenzoDepositInterface,
} from "../XRenzoDeposit.js";
...
export class XRenzoDeposit__factory {
  static readonly abi = _abi;
  static createInterface(): XRenzoDepositInterface {
    return new Interface(_abi) as XRenzoDepositInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): XRenzoDeposit {
    return new Contract(address, _abi, runner) as unknown as XRenzoDeposit;
  }
}
