...
export class IncentivesContract__factory {
  static readonly abi = _abi;
  static createInterface(): IncentivesContractInterface {
    return new Interface(_abi) as IncentivesContractInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IncentivesContract {
    return new Contract(address, _abi, runner) as unknown as IncentivesContract;
  }
}
