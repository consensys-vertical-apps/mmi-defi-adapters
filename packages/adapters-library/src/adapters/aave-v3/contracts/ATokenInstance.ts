...
export interface ATokenInstanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATOKEN_REVISION"
      | "DOMAIN_SEPARATOR"
...
export interface ATokenInstance extends BaseContract {
  connect(runner?: ContractRunner | null): ATokenInstance;
  waitForDeployment(): Promise<this>;

  interface: ATokenInstanceInterface;
