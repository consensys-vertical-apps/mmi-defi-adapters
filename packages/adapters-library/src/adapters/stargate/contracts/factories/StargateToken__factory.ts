...
import type { StargateToken, StargateTokenInterface } from "../StargateToken.js";
...
export class StargateToken__factory {
  ...
  static createInterface(): StargateTokenInterface {
    return new Interface(_abi) as StargateTokenInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): StargateToken {
    return new Contract(address, _abi, runner) as unknown as StargateToken;
  }
}
