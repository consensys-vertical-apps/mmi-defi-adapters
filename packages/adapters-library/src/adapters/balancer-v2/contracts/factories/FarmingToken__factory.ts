...
export class FarmingToken__factory {
  static readonly abi = _abi;
  static createInterface(): FarmingTokenInterface {
    return new Interface(_abi) as FarmingTokenInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): FarmingToken {
    return new Contract(address, _abi, runner) as unknown as FarmingToken;
  }
}
