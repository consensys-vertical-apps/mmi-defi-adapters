...
export class BalMinter__factory {
  static readonly abi = _abi;
  static createInterface(): BalMinterInterface {
    return new Interface(_abi) as BalMinterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): BalMinter {
    return new Contract(address, _abi, runner) as unknown as BalMinter;
  }
}
