...
import type {
  OneInchOracle,
  OneInchOracleInterface,
} from "../OneInchOracle.js";
...
export class OneInchOracle__factory {
  ...
  static createInterface(): OneInchOracleInterface {
    return new Interface(_abi) as OneInchOracleInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OneInchOracle {
    return new Contract(address, _abi, runner) as unknown as OneInchOracle;
  }
}
