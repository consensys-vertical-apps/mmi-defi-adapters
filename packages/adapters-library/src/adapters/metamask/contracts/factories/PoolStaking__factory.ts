...
import type { PoolStaking, PoolStakingInterface } from "../PoolStaking";
...
export class PoolStaking__factory {
  static readonly abi = _abi;
  static createInterface(): PoolStakingInterface {
    return new Interface(_abi) as PoolStakingInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PoolStaking {
    return new Contract(address, _abi, runner) as unknown as PoolStaking;
  }
}
