...
export class MetaRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): MetaRegistryInterface {
    return new Interface(_abi) as MetaRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MetaRegistry {
    return new Contract(address, _abi, runner) as unknown as MetaRegistry;
  }
}
