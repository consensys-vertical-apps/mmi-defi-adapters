...
export class GaugeN__factory {
  static readonly abi = _abi;
  static createInterface(): GaugeNInterface {
    return new Interface(_abi) as GaugeNInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): GaugeN {
    return new Contract(address, _abi, runner) as unknown as GaugeN;
  }
}
