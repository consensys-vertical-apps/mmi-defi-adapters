...
export class CompoundV3__factory {
  ...
  static createInterface(): CompoundV3Interface {
    return new Interface(_abi) as CompoundV3Interface;
  }
  static connect(address: string, runner?: ContractRunner | null): CompoundV3 {
    return new Contract(address, _abi, runner) as unknown as CompoundV3;
  }
}
