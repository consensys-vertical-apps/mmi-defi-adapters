...
export class SwEth__factory {
  ...
  static createInterface(): SwEthInterface {
    return new Interface(_abi) as SwEthInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): SwEth {
    return new Contract(address, _abi, runner) as unknown as SwEth;
  }
}
