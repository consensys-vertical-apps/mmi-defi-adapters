...
export class BeefyVaultV7__factory {
  static readonly abi = _abi;
  static createInterface(): BeefyVaultV7Interface {
    return new Interface(_abi) as BeefyVaultV7Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BeefyVaultV7 {
    return new Contract(address, _abi, runner) as unknown as BeefyVaultV7;
  }
}
