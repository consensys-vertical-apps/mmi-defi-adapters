...
import type { OraclePyYtLp, OraclePyYtLpInterface } from "../OraclePyYtLp";
...
export class OraclePyYtLp__factory {
  static readonly abi = _abi;
  static createInterface(): OraclePyYtLpInterface {
    return new Interface(_abi) as OraclePyYtLpInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OraclePyYtLp {
    return new Contract(address, _abi, runner) as unknown as OraclePyYtLp;
  }
}
