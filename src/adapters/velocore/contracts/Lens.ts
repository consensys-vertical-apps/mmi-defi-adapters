...
export interface LensInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "canonicalPools"
      | "queryGauge"
      | "spotPrice(address,bytes32,bytes32,uint256)"
      | "spotPrice(bytes32,bytes32[],uint256[])"
      | "spotPrice(bytes32,bytes32,uint256)"
      | "userBalances"
      | "wombatGauges"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "spotPrice(address,bytes32,bytes32,uint256)",
    values: [AddressLike, BytesLike, BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "spotPrice(bytes32,bytes32[],uint256[])",
...
export namespace FunctionChangedEvent {
  export type InputTuple = [
    sig: BytesLike,
...
export interface Lens extends BaseContract {
  ...
  "spotPrice(address,bytes32,bytes32,uint256)": TypedContractMethod<
    [
      swap: AddressLike,
      base: BytesLike,
      quote: BytesLike,
  ...
  "spotPrice(bytes32,bytes32[],uint256[])": TypedContractMethod<
    [quote: BytesLike, tok: BytesLike[], amount: BigNumberish[]],
    [bigint],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "spotPrice(address,bytes32,bytes32,uint256)"
  ): TypedContractMethod<
    [
      swap: AddressLike,
      base: BytesLike,
  ...
  >;
  getFunction(
    nameOrSignature: "spotPrice(bytes32,bytes32[],uint256[])"
  ): TypedContractMethod<
    [quote: BytesLike, tok: BytesLike[], amount: BigNumberish[]],
    [bigint],
    "nonpayable"
  ...
  getEvent(
    ...
    FunctionChangedEvent.InputTuple,
    FunctionChangedEvent.OutputTuple,
    FunctionChangedEvent.OutputObject
  >;
  getEvent(
    key: "Gauge"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "FunctionChanged(bytes4,address,bool)": TypedContractEvent<
      FunctionChangedEvent.InputTuple,
      FunctionChangedEvent.OutputTuple,
      FunctionChangedEvent.OutputObject
    >;
    FunctionChanged: TypedContractEvent<
      FunctionChangedEvent.InputTuple,
      FunctionChangedEvent.OutputTuple,
      FunctionChangedEvent.OutputObject
    >;
