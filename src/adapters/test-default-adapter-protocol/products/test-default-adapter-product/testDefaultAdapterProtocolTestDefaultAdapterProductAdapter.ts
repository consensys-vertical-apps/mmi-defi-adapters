...
export class TestDefaultAdapterProtocolTestDefaultAdapterProductAdapter
  implements IProtocolAdapter, IMetadataBuilder
{
  productId = 'test-default-adapter-product'
  protocolId: Protocol
  chainId: Chain
  ...
  getProtocolDetails(): ProtocolDetails {
    return {
      ...
      name: 'TestDefaultAdapterProtocol',
      description: 'TestDefaultAdapterProtocol defi adapter',
      siteUrl: 'https:',
      iconUrl: 'https://',
