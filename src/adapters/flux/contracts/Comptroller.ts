...
export namespace CompBorrowSpeedUpdatedEvent {
  export type InputTuple = [oToken: AddressLike, newSpeed: BigNumberish];
  export type OutputTuple = [oToken: string, newSpeed: bigint];
  export interface OutputObject {
    oToken: string;
    newSpeed: bigint;
  }
...
export namespace MarketEnteredEvent {
  export type InputTuple = [oToken: AddressLike, account: AddressLike];
  export type OutputTuple = [oToken: string, account: string];
  export interface OutputObject {
    oToken: string;
    account: string;
  }
...
export namespace MarketListedEvent {
  export type InputTuple = [oToken: AddressLike];
  export type OutputTuple = [oToken: string];
  export interface OutputObject {
    oToken: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export namespace NewBorrowCapEvent {
  export type InputTuple = [oToken: AddressLike, newBorrowCap: BigNumberish];
  export type OutputTuple = [oToken: string, newBorrowCap: bigint];
  export interface OutputObject {
    oToken: string;
    newBorrowCap: bigint;
  }
...
export interface Comptroller extends BaseContract {
  ...
  _setBorrowPaused: TypedContractMethod<
    [oToken: AddressLike, state: boolean],
    [boolean],
    "nonpayable"
  >;
  ...
  _setCollateralFactor: TypedContractMethod<
    [oToken: AddressLike, newCollateralFactorMantissa: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  _setMarketBorrowCaps: TypedContractMethod<
    [oTokens: AddressLike[], newBorrowCaps: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  borrowAllowed: TypedContractMethod<
    [oToken: AddressLike, borrower: AddressLike, borrowAmount: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  checkMembership: TypedContractMethod<
    [account: AddressLike, oToken: AddressLike],
    [boolean],
    "view"
  >;

  "claimComp(address,address[])": TypedContractMethod<
    [holder: AddressLike, oTokens: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  isDeprecated: TypedContractMethod<[oToken: AddressLike], [boolean], "view">;
  ...
  liquidateBorrowAllowed: TypedContractMethod<
    [
      oTokenBorrowed: AddressLike,
      oTokenCollateral: AddressLike,
  ...
  mintAllowed: TypedContractMethod<
    [oToken: AddressLike, minter: AddressLike, mintAmount: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  redeemAllowed: TypedContractMethod<
    [oToken: AddressLike, redeemer: AddressLike, redeemTokens: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[oToken: AddressLike], [bigint], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[oTokens: AddressLike[]], [bigint[]], "nonpayable">;
  getFunction(
    nameOrSignature: "exitMarket"
  ): TypedContractMethod<[oTokenAddress: AddressLike], [bigint], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[oToken: AddressLike], [boolean], "view">;
  getFunction(
