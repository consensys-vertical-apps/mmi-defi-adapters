...
export interface ConvexFactoryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "FEE_DENOMINATOR"
      | "MaxFees"
...
export interface ConvexFactoryV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ConvexFactoryV2;
  waitForDeployment(): Promise<this>;

  interface: ConvexFactoryV2Interface;
