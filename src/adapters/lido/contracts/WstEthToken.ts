...
export interface WstEthTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface WstEthToken extends BaseContract {
  connect(runner?: ContractRunner | null): WstEthToken;
  waitForDeployment(): Promise<this>;

  interface: WstEthTokenInterface;
