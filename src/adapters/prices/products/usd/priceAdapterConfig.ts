...
const QUOTER_CONTRACT = getAddress('0xb27308f9f90d607463bb33ea1bebb41c27ce5ab6')
...
export const priceAdapterConfig = {
  ...
  wrappedEth: {
    ...
    addresses: {
      ...
      [Chain.Bsc]: getAddress('0x2170ed0880ac9a755fd29b2688956bd959f933f8'),
      [Chain.Polygon]: getAddress('0x7ceb23fd6bc0add59e62ac25578270cff1b9f619'),
      [Chain.Fantom]: getAddress('0x74b23882a30290451a17c44f4f05243b6b58c76d'),
      [Chain.Base]: getAddress('0x4200000000000000000000000000000000000006'),
  ...
  chainlink: {
    ...
    UsdEthFeedAddresses: {
      ...
      [Chain.Bsc]: getAddress('0x9ef1b8c0e4f7dc8bf5719ea496883dc6401d5b2e'),
      [Chain.Polygon]: getAddress('0xf9680d99d6c9589e2a93a78a04a279e509205945'),
      [Chain.Fantom]: getAddress('0x11ddd3d147e5b83d01cee7070027092397d63658'),
      [Chain.Base]: getAddress('0x71041dddad3595f9ced3dccfbe3d1f4b0a16bb70'),
      [Chain.Arbitrum]: getAddress(
      ...
      [Chain.Linea]: getAddress('0x3c6cd9cc7c7a4c2cf5a82734cd249d7d593354da'),
    },
  },
  nativeToken: {
    addresses: [
