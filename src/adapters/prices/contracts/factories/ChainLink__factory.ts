...
export class ChainLink__factory {
  ...
  static createInterface(): ChainLinkInterface {
    return new Interface(_abi) as ChainLinkInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ChainLink {
    return new Contract(address, _abi, runner) as unknown as ChainLink;
  }
}
