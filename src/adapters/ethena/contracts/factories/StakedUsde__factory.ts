...
import type { StakedUsde, StakedUsdeInterface } from "../StakedUsde";
...
export class StakedUsde__factory {
  static readonly abi = _abi;
  static createInterface(): StakedUsdeInterface {
    return new Interface(_abi) as StakedUsdeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): StakedUsde {
    return new Contract(address, _abi, runner) as unknown as StakedUsde;
  }
}
