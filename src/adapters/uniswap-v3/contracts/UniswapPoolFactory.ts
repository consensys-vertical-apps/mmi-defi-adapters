...
export interface UniswapPoolFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createPool"
      | "enableFeeAmount"
...
export interface UniswapPoolFactory extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapPoolFactory;
  waitForDeployment(): Promise<this>;

  interface: UniswapPoolFactoryInterface;
