...
export interface UniswapPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface UniswapPool extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapPool;
  waitForDeployment(): Promise<this>;

  interface: UniswapPoolInterface;
