...
function runAllTests() {
  ...
  runProtocolTests(Protocol.MorphoCompoundV2,morphoCompoundV2OptimizerTestCases)
  runProtocolTests(Protocol.MorphoAaveV3ETHOptimizer,morphoAaveV3ETHOptimizerTestCases)
}
